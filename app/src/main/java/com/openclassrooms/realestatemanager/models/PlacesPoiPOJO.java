...
public class PlacesPoiPOJO {
     ...
     * @param status
     */
    public PlacesPoiPOJO(List<Object> htmlAttributions, List<Result> results, String status) {
        super();
    ...
    public PlacesPoiPOJO withHtmlAttributions(List<Object> htmlAttributions) {
        this.htmlAttributions = htmlAttributions;
        return this;
    }
    ...
    public PlacesPoiPOJO withResults(List<Result> results) {
        this.results = results;
        return this;
    }
    ...
    public PlacesPoiPOJO withStatus(String status) {
        this.status = status;
        return this;
    }
